...
class Game {
    constructor(){
        ...
        this.anims.forEach(function(anim) {
            options.assets.push(`${ASSET_PATH}fbx/${anim}.fbx`);
        });
        const preloader = new _preloaderJs.Preloader(options);
    }
    init() {
        ...
        const game2 = this;
        console.log("wsh, ", `${ASSET_PATH}fbx/girl-walk.fbx`);
        loader.load(`${ASSET_PATH}fbx/girl-walk.fbx`, function(object) {
            console.log("plt");
            object.mixer = new THREE.AnimationMixer(object);
            object.mixer.addEventListener("finished", function(e) {
                game2.action = "look-around";
            });
            object.castShadow = true;
            game2.player.mixer = object.mixer;
            game2.player.root = object.mixer.getRoot();
            ...
            game2.scene.add(object);
            game2.player.object = object;
            game2.player.walk = object.animations[0];
            game2.createCameras();
            game2.loadEnvironment(loader);
        }, null, this.onError);
        console.log("wesh");
    ...
    loadEnvironment(loader) {
        const game3 = this;
        loader.load(`${ASSET_PATH}fbx/environment.fbx`, function(object) {
            game3.scene.add(object);
            game3.doors = [];
            game3.fans = [];
...
},{"./Preloader.js":"hjzcr"}],"hjzcr":[function(require,module,exports) {
...
class Preloader {
    constructor(options){
        ...
        if (options.onprogress == undefined) {
            ...
            if (this.container != undefined) this.container.appendChild(this.domElement);
            else document.body.appendChild(this.domElement);
        } else this.onprogress = options.onprogress;
            ...
            if (xobj.readyState == 4 && xobj.status == "200") {
                ...
                if (loader.checkCompleted()) {
                    if (loader.domElement != undefined) {
                        if (loader.container != undefined) loader.container.removeChild(loader.domElement);
                        else document.body.removeChild(loader.domElement);
                    }
                    loader.oncomplete();
                }
            }
...
},{}]},["jKwHT","bNKaB"], "bNKaB", "parcelRequire5120")
